...
export class ReviewsComponent implements OnInit {
      ...
      fetchplacesdetails()
  {
    ...
    this.rating=this.placesService.ratingex,
    this.review_count=this.placesService.review_countex;
    this.id = this.placesService.id;
  };
  WriteReview(reviews,rating,name,id) {
    console.log('in review service')
    console.log(reviews)
    console.log(rating)
    console.log(this.placesService.nameex)
    console.log(this.placesService.id)
     this.reviewService.createReview(reviews,rating,this.placesService.nameex,this.placesService.id)
