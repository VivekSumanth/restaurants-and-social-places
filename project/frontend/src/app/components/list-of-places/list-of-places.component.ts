...
export class ListOfPlacesComponent implements OnInit {
  ...
  findPlacedetail(name,display_phone,address1,is_closed,rating,review_count,id){
    console.log(name,display_phone,address1,is_closed,rating,review_count,id)
    console.log(display_phone)
     this.placesService.findPlacedetail(name,display_phone,address1,is_closed,rating,review_count,id)
    //.subscribe(() => {
