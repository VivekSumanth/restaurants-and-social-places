...
placename:any;
  findPlacedetail(name,phone,address1,is_closed,rating,review_count,id) {
    ...
    this.id = id;
    console.log('printing place detail')
    console.log( this.nameex,this.addressex,this.phoneex,this.is_closedex,this.ratingex,this.review_countex,this.id)
